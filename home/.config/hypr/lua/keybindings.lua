...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(programs.launcher))
...
-- Media control through playerctl
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl previous"), { locked = true })
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl next"), { locked = true })

-- alternatives using Pause, Scroll_Lock
hl.bind("Pause", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind("Scroll_Lock", hl.dsp.exec_cmd("playerctl next"), { locked = true })
hl.bind("SHIFT + Scroll_Lock", hl.dsp.exec_cmd("playerctl previous"), { locked = true })
